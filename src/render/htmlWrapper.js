...
export function renderHTML(body, pLink, pIdx) {
  ...
  <html lang="en">
    <head>
      ...
      <script data-ad-client="ca-pub-9917066068847885" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
      <title>Parksi's OneDrive</title>
    ...
    <body>
      <nav id="navbar" data-turbolinks-permanent><div class="brand">📁 Parksi's OneDrive Index</div></nav>
      ${body}
